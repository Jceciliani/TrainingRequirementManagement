...
<body>
        <div class="logo-placement" style="right: 0px"><img style="height: 90px; margin-right:15px; margin-top:15px; " src="<c:url value="resources/img/AtosSyntelLogoLargeBlue.png" />"></div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="row" style="padding-left:40px">
                    	<img class="Logo-size" src="<c:url value="resources/img/trm.png" />" >	
                    	<h3 style="margin-top:35px">TRM Sign In</h3>
                    </div>
                    </center>
                </div>
                <div class="card-body">
