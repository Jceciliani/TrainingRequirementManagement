	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul style="font-weight: 500;" class="navbar-nav ml-auto">
				...
				<li class="nav-item" style="cursor: pointer"><a style="color: white;"
					class="nav-link" href="">Run Report</a></li>
				<li class="nav-item"><a class="nav-link"
					href="vendormanagement/0" style="cursor: pointer; color: white;">Vendor
						Management</a></li>
