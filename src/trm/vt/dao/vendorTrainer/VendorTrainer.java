...
public class VendorTrainer {
	...
	public int getVendor_details_id() {
		return vendor_details_id;
	}
	public void setVendor_details_id(int vendor_details_id) {
		this.vendor_details_id = vendor_details_id;
	}
