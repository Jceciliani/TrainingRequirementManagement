...
public class TrainingSchedule {
	...
	int training_schedule_id;
	String training_city;
	String training_state;
	String training_country;
	String training_zipcode;
	String training_time_zone;
	String training_location;
	String training_room_number;
	String training_start_date;
	String training_end_date;
	String training_break_down;
	String training_url;
	String training_phone;
