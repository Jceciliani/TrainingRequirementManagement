package trm.vt.dao.vendorTrainingRequest;
...
public class VendorTrainingRequestDAO {
	...
	public void updateVendorTrainingRequestWithScheduleId(int schedule_id, int vendor_training_request_id) {
		
		String sql = "update vendor_training_request set schedule_id = ? where VENDOR_TRAINING_REQUEST_ID = ?";
		
		temp.update(sql, new Object[] {schedule_id,vendor_training_request_id});
	}
}
