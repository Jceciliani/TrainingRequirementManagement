...
public class Training_ParticipantsDAO {
	...
	//System.out.println(request.getParameter("trid")+"  "+request.getParameter("eid"));
	public boolean deleteTraining_Participants(int trid, int eid) {
		String sql = "delete from training_participants where participant_employee_id = ? and training_session_attended = ?";
		int num = temp.update(sql, new Object[]{eid, trid});
