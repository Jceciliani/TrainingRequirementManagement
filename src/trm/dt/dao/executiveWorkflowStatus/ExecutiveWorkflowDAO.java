...
public class ExecutiveWorkflowDAO 
{
	...
	public void insertTempExecutiveWorkflow(int training_request_id)
	{
		temp.update("insert into Executive_Workflow_Status (executive_workflow_status_id, training_request_id) values"
				+ "(executive_workflow_status_seq.nextval,?)",new Object[]
				{training_request_id});
	}
}
